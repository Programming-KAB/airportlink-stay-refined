  ...
  return (
    <div className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        <a 
          href="https://away2uganda.com" 
          target="_blank" 
          rel="noopener noreferrer"
          className="block"
        >
          <div className="rounded-lg overflow-hidden shadow-xl relative cursor-pointer hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="relative z-10 p-10 text-white text-center">
              ...
              <Button className="bg-[#4CAF50] hover:bg-[#388E3C] text-white px-8 py-3 text-lg pointer-events-none">
                Book Your Safari
              </Button>
            </div>
          </div>
